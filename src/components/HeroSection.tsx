...
const HeroSection = () => {
  ...
  useEffect(() => {
    if (iframeRef.current) {
      iframeRef.current.src = "https://www.youtube.com/embed/JD4cIHOSly0?autoplay=1&mute=1&rel=0&modestbranding=1&vq=hd1080";
    }
  }, []);
      ...
      <div className="relative z-10 max-w-4xl mx-auto text-center">
        ...
        <div className="relative w-full aspect-video rounded-2xl overflow-hidden border border-border glow-primary animate-fade-up-delay-2">
          <iframe
            ...
            src="https://www.youtube.com/embed/JD4cIHOSly0?autoplay=1&mute=1&rel=0&modestbranding=1&vq=hd1080"
